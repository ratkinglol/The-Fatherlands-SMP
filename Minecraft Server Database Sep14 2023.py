...
def to_do_list():
    authorization1 = input("Authorization Required - ")
    if authorization1 == "Kasen" or "kasen" or "Foster" or "foster" or "aveen" or "Aveen": 
...
tax_law_change_sep7 = "There is now only 2 strikes for tax evasion instead of three and the jail time was extended."
...
help_test_sep13_2023 = 0
list_data_august_31_2023_test_sep13_2023 = 1
list_data_september_1_2023_test_sep14_2023 = 0
list_data_september_2_2023_test_sep14_2023 = 0
list_data_september_3_2023_test_sep14_2023 = 0
list_data_september_4_2023_test_sep14_2023 = 0
list_data_september_5_2023_test_sep14_2023 = 0
list_data_september_6_2023_test_sep14_2023 = 0
list_data_september_7_2023_test_sep14_2023 = 0
list_data_september_8_2023_test_sep14_2023 = 0
list_data_september_9_2023_test_sep14_2023 = 0
list_data_september_10_2023_test_sep14_2023 = 0
list_data_september_11_2023_test_sep14_2023 = 0
list_data_september_12_2023_test_sep14_2023 = 0
list_data_september_13_2023_test_sep14_2023 = 0
list_data_september_14_2023_test_sep14_2023 = 0



def help():
    if help_test_sep13_2023 == 1:
        print(" ")
        print("To find out")
    else:
        print("this command is still being developed.")




def list_data_august_31_2023():
    if list_data_august_31_2023_test_sep13_2023 == 1:
        print(" ")
        print(aug31_diamond)
        print(" ")
        print(aug31_gold) 
...
def list_data_september_1_2023():
    if list_data_september_1_2023_test_sep14_2023 == 1:
        print(" ")
    else:
        print("This command is still being developed.")
...
def list_data_september_2_2023():
    if list_data_september_2_2023_test_sep14_2023 == 1:
        print(" ")
    else:
        print("This command is still being developed.")
...
def list_data_september_3_2023():
    if list_data_september_3_2023_test_sep14_2023 == 1:
        print(" ")
    else:
        print("This command is still being developed.")
...
def list_data_september_4_2023():
    if list_data_september_4_2023_test_sep14_2023 == 1:
        print(" ")
    else:
        print("This command is still being developed.")
...
def list_data_september_5_2023():
    if list_data_september_5_2023_test_sep14_2023 == 1:
        print(" ")
    else:
        print("This command is still being developed.")
...
def list_data_september_6_2023():
    if list_data_september_6_2023_test_sep14_2023 == 1:
        print(" ")
    else:
        print("This command is still being developed.")
...
def list_data_september_7_2023():
    if list_data_september_7_2023_test_sep14_2023 == 1:
        print(" ")
    else:
        print("This command is still being developed.")
...
def list_data_september_8_2023():
    if list_data_september_8_2023_test_sep14_2023 == 1:
        print(" ")
    else:
        print("This command is still being developed.")
...
def list_data_september_9_2023():
    if list_data_september_9_2023_test_sep14_2023 == 1:
        print(" ")
    else:
        print("This command is still being developed.")
...
def list_data_september_10_2023():
    if list_data_september_10_2023_test_sep14_2023 == 1:
        print(" ")
    else:
        print("This command is still being developed.")
...
def list_data_september_11_2023():
    if list_data_september_11_2023_test_sep14_2023 == 1:
        print(" ")
    else:
        print("This command is still being developed.")
...
def list_data_september_12_2023():
    if list_data_september_12_2023_test_sep14_2023 == 1:
        print(" ")
    else:
        print("This command is still being developed.")
...
def list_data_september_13_2023():
    if list_data_september_13_2023_test_sep14_2023 == 1:
        print(" ")
    else:
        print("This command is still being developed.")
...
def list_data_september_14_2023():
    if list_data_september_14_2023_test_sep14_2023 == 1:
        print(" ")
    else:
        print("This command is still being developed.")
...
def foster_aug31_2023():
    print(" ")
    print(foster_diamonds_aug31)
    print(" ")
    print(foster_diamonds_tab_aug31)
    print(" ")
    print(foster_iron_tab_aug31)
...
aveen_taxes_owe_sep3 = "Aveen Owes No Taxes On September 3rd"
foster_taxes_owe_sep3 = "Foster Owes No Taxes On September 3rd"
...
def test_authorization2():
    if test0005 == 0:
        if testfailsafe0005 == 0:
            test0005_1 = input("Authorization Required - ")
            if test0005_1 == "kasen" or "Kasen":
                print("LOGIN SUCCESSFUL")
                authorized = 1
            else:
                print("LOGIN UNSUCCESSFUL")
